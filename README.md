...
- первичная подготовка Deskgram 2 перед запуском инфраструктурных и рабочих модулей;
- подключение AI-провайдеров перед [нейрокомментингом](https://github.com/Deskgram-2/telegram-neuro-commenting-deskgram) и другими AI-сценариями;
- выравнивание системы перед большой кампанией, когда нужно проверить общие параметры, уведомления и API;
- стандартизация рабочего контура для команды, если несколько операторов используют одну и ту же программу и сценарии.

## Что выбрать: настройки или панель аккаунтов

| Если ваша задача | Что подходит лучше |
|---|---|
| Подготовить системную среду, API-ключи и общие параметры | `Настройки` |
| Собрать и организовать рабочую базу Telegram-аккаунтов | [Панель аккаунтов](https://github.com/Deskgram-2/telegram-account-manager-deskgram) |
| Проверить глобальную готовность Deskgram 2 перед стартом модулей | `Настройки` |
| Разложить аккаунты по группам и папкам под конкретные сценарии | [Панель аккаунтов](https://github.com/Deskgram-2/telegram-account-manager-deskgram) |
